...
const REQUIRED_TRIPLETS = ("x86_64-linux-gnu", "aarch64-apple-darwin")
const REQUIRED_PLATFORMS = parse.(Platform, REQUIRED_TRIPLETS)
...
const REPO_URL = set_url_scheme(remote_url(REPO_PATH), "https")
